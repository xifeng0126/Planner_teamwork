...
public:
    ...
    void setupUi(QMainWindow *noteWindow)
    {
        ...
        tableView_2 = new table(community);
        ...
        gridLayout->addWidget(stackedWidget, 0, 0, 4, 1);
    ...
    {
        noteWindow->setWindowTitle(QCoreApplication::translate("noteWindow", "MainWindow", nullptr));
