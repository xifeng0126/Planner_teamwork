...
public:
    ...
    void setupUi(QWidget *login)
    {
        ...
        gridLayout->addWidget(passWord, 7, 2, 1, 1);

        GoSignUp = new QPushButton(widget);
        GoSignUp->setObjectName(QString::fromUtf8("GoSignUp"));

        gridLayout->addWidget(GoSignUp, 1, 2, 1, 1);
    ...
    void retranslateUi(QWidget *login)
    {
        ...
        GoSignUp->setText(QCoreApplication::translate("login", "\346\263\250\345\206\214\344\270\200\344\270\252", nullptr));
