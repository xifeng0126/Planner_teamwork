...
#include "../../planner_teamwork/mytableview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myTableView_t, stringdata) + ofs \
...
void *myTableView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myTableView.stringdata))
