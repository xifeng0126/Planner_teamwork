...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_textWidget_t, stringdata) + ofs \
...
const QMetaObject textWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_textWidget.data,
      qt_meta_data_textWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *textWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_textWidget.stringdata))
